<template>
  <div class="relative mb-6">
    <button @click="scrollLeft"
      class="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-2 bg-grayCustom-700 rounded-full shadow-md hover:bg-grayCustom-600 transition">
    ...
    <button @click="scrollRight"
      class="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 bg-grayCustom-700 rounded-full shadow-md hover:bg-grayCustom-600 transition">
      <svg class="w-5 h-5 text-grayCustom-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
